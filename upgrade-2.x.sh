...
# Check board support
case $SLUG in
    artik53*|artik710|bananapi-m1-plus|beaglebone*|fincm3|imx6ul-var-dart|jetson-tx1|jetson-tx2|odroid-c1|odroid-xu4|orangepi-plus2|orbitty-tx2|raspberry*|skx2|ts4900)
        binary_type=arm
        ;;
